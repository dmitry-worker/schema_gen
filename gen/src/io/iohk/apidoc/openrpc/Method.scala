...
object Method {
  ...
  // @tailrec
  def collect0(acc: Map[String, TypeDefinition], parameters: Seq[agnostic.Parameter]): Map[String, TypeDefinition] = {
    
    @tailrec
    def collect1(acc: Map[String, TypeDefinition], parameter: agnostic.Parameter): Map[String, TypeDefinition] = {
      parameter match {
